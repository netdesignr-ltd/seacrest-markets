const plateform = () => {
  ...
  return (
    ...
    <div className="pt-32 pb-24 mx-auto md:max-w- 7xl md:max-w-[100%]">
      <div className="grid items-center md:grid-cols-2 place-content-center place">
       
        <div className="mt-40 md:mt-10 ">
          <img src="/tradingplateformbg.svg" alt="trading plateform" />
        </div>

        <div>
          <h1 className="text-4xl font-bold text-center text-seacrest-450 md:text-left">
            Trading Platforms
          </h1>
         ...
         <div>
            ...
            <div>
                <h1 className="py-3 text-2xl font-bold text-center md:text-left text-seacrest-600">
                 {data.title}
                </h1>
                <p className="text-base font-medium text-left text-center md:w-3/4 text-seacrest-550 md:text-left">
                 {data.description}
                </p>
              </div>
            </div>
